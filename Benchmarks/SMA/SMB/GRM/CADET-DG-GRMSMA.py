...
def model(nelem, polyDeg, polyDegPore, is_exact):
    ...
    smb_model.root.input.model.unit_004.par_diffusion = [70.0e-11, 6.07e-11, 6.07e-11, 6.07e-11]
    ...
    smb_model.root.input.model.unit_004.discretization.par_nelem  = 1 
    
    #Polynomial order 
    smb_model.root.input.model.unit_004.discretization.polyDeg = polyDeg
    smb_model.root.input.model.unit_004.discretization.par_polyDeg = polyDegPore
    smb_model.root.input.model.unit_004.discretization.exact_integration = is_exact
    smb_model.root.input.model.unit_004.discretization.par_exact_integration = 1
...
runCadetDG("GRM", c_analytical, polyDeg, nCells, ncolumns, polyDegPore)

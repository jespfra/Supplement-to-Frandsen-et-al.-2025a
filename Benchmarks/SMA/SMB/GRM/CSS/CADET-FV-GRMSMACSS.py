...
#Setting up the model
    ...
    smb_model.root.input.model.unit_004.discretization.ncol = 2**ncol #Should be high enough 
    smb_model.root.input.model.unit_004.discretization.npar = 2**(ncol-2) #Should be high enough 
...
c_analytical = pd.read_csv('Semi-analytical_GRM_SMA_CSS.csv')
...
Evaluate_CADETDG_css(model=model, c_analytical=c_analytical, nCells=k, polyDeg=0, polyDegPore=[0], nCellsPar=1, max_iter=1000, css_tol=1e-6)

...
Evaluate_CADETDG_css(model=model, c_analytical=c_analytical, nCells=nCells, polyDeg=polyDeg, polyDegPore=polyDegPore, nCellsPar=1, max_iter=1000, css_tol=1e-6)

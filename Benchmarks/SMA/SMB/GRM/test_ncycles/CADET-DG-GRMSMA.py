...
def model(ncol,polyDeg, polyDegPore,ncycles):
...
for setting in settings:
    for ncycle in n_cycles:
        ...
        df, rtime, rtime_tot = model(setting['nCells'], setting['polyDeg'], setting['polyDegPore'], ncycle)
        ...
        results.append({
            ...
            'polyDegPore': setting['polyDegPore'],
            'nCycles': ncycle,
            'rtime': rtime,
            'rtime_tot':rtime_tot
        })

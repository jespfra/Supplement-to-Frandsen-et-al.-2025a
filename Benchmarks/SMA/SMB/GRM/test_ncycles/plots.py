...
for setting in unique_settings:
    ...
    markerss.append(plt.Line2D([], [], color='black', marker=f'{markers[i]}', linestyle='None', label=f"$N_d^b$ = {data_CADETDG['polyDeg'][idxx].iloc[0]}, $N_d^p$ = {data_CADETDG['polyDegPore'][idxx].iloc[0]}, $N_e$ = {data_CADETDG['nCells'][idxx].iloc[0]}",markersize=12))

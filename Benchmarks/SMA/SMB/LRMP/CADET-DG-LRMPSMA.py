...
Cadet.cadet_path = r'C:\Users\pbzit\source\Test_gsmJan\out\install\aRELEASE\bin\cadet-cli'
...
df, rtime, r = model(4,4,0)

exec(open('../../../benchmark_runner.py').read())
runCadetDG("LRMP", c_analytical, polyDeg, nCells, ncolumns)

...
using Plots
plot()
plot!(outlets[1].solution_outlet[end-1800:end,2])
plot!(outlets[1].solution_outlet[end-1800:end,3])
plot!(outlets[1].solution_outlet[end-1800:end,4])
...
CSV.write(joinpath(@__DIR__,"Semi-analytical_LRMP_SMA.csv"), df)     

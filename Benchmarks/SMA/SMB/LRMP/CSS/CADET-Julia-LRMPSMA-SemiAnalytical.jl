...
function model_setup(Q2,Q4,QF,QD,QE,QR,ts,nCells, polyDeg, exactInt, analJac=false)
	...
	model["root"]["input"]["model"]["unit_004"]["film_diffusion"] = [3.3e-3, 3.3e-3, 3.3e-3, 3.3e-3]
...
inlets, outlets, columns, switches, solverOptions = model_setup(Q2,Q4,QF,QD,QE,QR,ts, 64, 6, 1)
...
CSV.write(joinpath(@__DIR__,"Semi-analytical_LRMP_SMA_CSS.csv"), df)     

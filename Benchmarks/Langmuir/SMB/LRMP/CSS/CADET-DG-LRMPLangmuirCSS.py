...
def model(nelem, polydeg, polydegpore, exactInt=True, state_y=[0], state_ydot=[0]): #ncol = 4, polydeg = 4, exactInt = 1
    ...
    smb_model.root.input.model.unit_000.sec_000.const_coeff = [CfA, CfA] #Inlet flowrate concentration
...
Evaluate_CADETDG_css(model=model, c_analytical=c_analytical, nCells=nCells, polyDeg=polyDeg, polyDegPore=0, nCellsPar=1, max_iter=150*8, css_tol=1e-6)

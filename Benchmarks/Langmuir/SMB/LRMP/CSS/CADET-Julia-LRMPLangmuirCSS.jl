...
function model_setup(Q1,Q2,Q3,Q4,QF,QD,QE,QR,ts, nCells, polyDeg, exactInt, oca_fpi=false, css = false)
...
inlets, outlets, columns, switches, solverOptions = model_setup(Q1,Q2,Q3,Q4,QF,QD,QE,QR,ts, 4, 4, false, false,  true)

# Evaluate CSS convergence 
c_analytical = CSV.read(joinpath(@__DIR__,"Semi-analytical_LRMP_Langmuir_CSS.csv"), DataFrame)
evaluate_css(Q1,Q2,Q3,Q4,QF,QD,QE,QR,ts, QNDF(autodiff=false), c_analytical, nComp, nCell, polyDeg, 1, "LRMP", @__DIR__)

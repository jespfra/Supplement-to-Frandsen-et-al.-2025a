...
inlets, outlets, columns, switches, solverOptions = model_setup(Q1,Q2,Q3,Q4,QF,QD,QE,QR,ts, 4, 4, 0, 5)
...
settings = [
    (nCells = 4, polyDeg = 4, setting_name = "Setting 1"),
    (nCells = 16, polyDeg = 5, setting_name = "Setting 2"),
    (nCells = 32, polyDeg = 6, setting_name = "Setting 3")
]

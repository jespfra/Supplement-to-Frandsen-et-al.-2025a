...
df = DataFrame(C0_E = outlets[1].solution_outlet[:,1], C1_E = outlets[1].solution_outlet[:,2],
               C0_R = outlets[2].solution_outlet[:,1], C1_R = outlets[2].solution_outlet[:,2])
CSV.write(joinpath(@__DIR__,"Semi-analytical_LRM_Linear.csv"), df)    

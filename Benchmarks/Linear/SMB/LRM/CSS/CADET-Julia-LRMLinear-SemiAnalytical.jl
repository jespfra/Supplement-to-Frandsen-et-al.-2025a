...
function model_setup(Q1,Q2,Q3,Q4,QF,QD,QE,QR,ts, nCells, polyDeg, exactInt, analJac=false)
    ...
    model["root"]["input"]["solver"]["css"]["css_max_iter"] = 1500      # Set max number of iterations 
...
inlets, outlets, columns, switches, solverOptions = model_setup(Q1,Q2,Q3,Q4,QF,QD,QE,QR,ts, 64, 6, 1)
...
CSV.write(joinpath(@__DIR__,"Semi-analytical_LRM_Linear_CSS.csv"), df)     
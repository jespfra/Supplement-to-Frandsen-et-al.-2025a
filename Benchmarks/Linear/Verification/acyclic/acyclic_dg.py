...
def Acyclic_model1(nelem,polydeg,exactInt):
    ...
    Acyclic_model.root.input.model.unit_001.sec_000.const_coeff = [1] #Desorbent stream  
    ...
    Acyclic_model.root.input.solver.time_integrator.algtol = 1e-12
    Acyclic_model.root.input.solver.time_integrator.reltol = 1e-10 #Relative tolerance
    Acyclic_model.root.input.solver.time_integrator.init_step_size = 1e-12
    ...
    Acyclic_model.filename = 'ModelDG.h5'
    Acyclic_model.save()
